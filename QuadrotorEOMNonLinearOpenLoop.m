...
% File name: QuadrotorEOMNonLinearOpenLoop
% Created: 4/3/26
function [var_dot,Controls] = QuadrotorEOMNonLinearOpenLoop(t, var, g, m, I, d, km, nu, mu, motor_forces)
...
%of the Quadrotor. This function now is able to handle the rapid changes
%due to open loop control.

%This is the code associated with Part 3.7
